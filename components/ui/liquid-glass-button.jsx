...
const colorVariants = {
  default: {
    outer: "bg-gradient-to-b from-[#1a1a1a] to-[#404040]",
    inner: "bg-gradient-to-b from-[#2a2a2a] via-[#1a1a1a] to-[#303030]",
    button: "bg-gradient-to-b from-[#404040] to-[#2a2a2a]",
    textColor: "text-slate-200",
    textShadow: "[text-shadow:_0_-1px_0_rgb(20_20_20_/_100%)]",
  },
  orange: {
    outer: "bg-gradient-to-b from-[#ea580c] to-[#fb923c]",
    inner: "bg-gradient-to-b from-[#f97316] via-[#ea580c] to-[#fb923c]",
    button: "bg-gradient-to-b from-[#fb923c] to-[#ea580c]",
